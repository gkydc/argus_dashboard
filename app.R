...
library(DT)
library(openxlsx)
# ===== SAMPLE DATA (replace with your real df; keep check.names = FALSE) =====
df <- read.csv("summary_stats_daynight.csv")
# Defaults preselected in the Parameter picker (if available)
...
# ===== Plot helper (adds optional vertical target line) =====
